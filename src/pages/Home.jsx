  ...
  return (
    ...
    <div className="container mx-auto flex px-5 py-12 md:flex-row flex-col items-center">
      ...
      <h1 className="text-xl font-extrabold sm:text-3xl text-color-principal pb-2">
        ...
        <Link to="/registrarse">
            <Button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg me-2">Regístrate</Button>
          </Link>
          <Link to="/espiritual">
            <Button className="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">Explorar</Button>
          </Link>
        </div>
      </div>
...
<section className="mb-32 text-gray-800 text-center mt-8">
  ...
  Conoce al <u className="text-color-principal">equipo</u>
  </h2>
  <div className="grid gap-x-6 lg:gap-x-12 md:grid-cols-3">
    <div className="mb-24 md:mb-0">
      <div className="rounded-lg shadow-lg h-full block bg-white">
        ...
        <div className="p-6">
          <h5 className="text-lg font-bold mb-4">Victor Trujillo</h5>
    ...
    <div className="mb-24 md:mb-0">
      <div className="rounded-lg shadow-lg h-full block bg-white">
        ...
        <div className="p-6">
          <h5 className="text-lg font-bold mb-4">Alcides Salazar</h5>
          <p className="mb-6">Frontend Developer</p>
          <ul className="list-inside flex mx-auto justify-center">
            <a href="#!" className="px-2">
            <svg
    ...
    <div className="">
      <div className="rounded-lg shadow-lg h-full block bg-white">
        ...
        <div className="p-6">
          <h5 className="text-lg font-bold mb-4">Fernando Peñaloza</h5>
          <p className="mb-6">Frontend Developer</p>
          <ul className="list-inside flex mx-auto justify-center">
            <a href="#!" className="px-2">
              <svg
